package com.atguigu.mybatisplus.generator;
...
public class MyGenerator
{
    public static void main(String[] args) {
        ...
        FastAutoGenerator.create("jdbc:mysql://hadoop102:3306/Mybatis","root","000000")
                         .globalConfig(builder -> {
                             builder.author("atguigu")               //作者
                                    .outputDir("D:\\javaCode\\Data-Governance\\MybatisPlus\\src\\main\\java")    //输出路径(写到java目录)
